...
- (void)setUp
{
    NSString *roundPath = [[NSBundle mainBundle]pathForResource:@"round.png" ofType:@""];
    
    UIImage  *roundImage= [UIImage imageWithContentsOfFile:roundPath];
    ...
    self.progress = 0.;
    self.outerRadiusRatio = 0.4;
    self.innerRadiusRatio = 0.30;
   // self.overlayColor = [UIColor colorWithRed:0. green:0. blue:0. alpha:0.5];
    self.overlayColor = [UIColor colorWithRed:255 green:255 blue:255 alpha:0.9];
